    ...
    const iconUrl = `https://openweathermap.org/img/wn/${weather.icon}@2x.png`;
      ...
      <div class="row align-items-center mb-4 p-3 border rounded shadow-sm bg-light">
        ...
        <div class="col-2 text-center">
          <img src="${iconUrl}" alt="${weather.description}" class="img-fluid" />
        ...
        <div class="col-10">
          ...
          <div class="row small">
            ...
            <div class="col-md-4"><strong>Humidity:</strong> ${data.humidity}%</div>
            <div class="col-md-4"><strong>Rain:</strong> ${data.rain ?? 0} mm</div>
            <div class="col-md-4"><strong>Wind:</strong> ${data.wind_speed} m/s</div>
            <div class="col-md-4"><strong>Pressure:</strong> ${data.pressure} hPa</div>
